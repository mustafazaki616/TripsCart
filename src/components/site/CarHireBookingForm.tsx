    ...
    <>
      <div className="w-full">
         ...
         <div className="block md:hidden space-y-3">
           ...
           <div>
             <label className="text-xs text-gray-500 mb-0.5 block" htmlFor="car-class-economy-m">Car Class</label>
             <div className="flex bg-secondary/60 rounded-md p-1 h-12">
               <label className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors cursor-pointer" htmlFor="car-class-economy-m">
                 <input
                   id="car-class-economy-m"
                   type="radio"
                   name="class"
                   value="Economy"
               ...
               <label className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors cursor-pointer" htmlFor="car-class-business-m">
                 <input
                   id="car-class-business-m"
                   type="radio"
                   name="class"
                   value="Business"
                   className="accent-[hsl(var(--primary))]"
