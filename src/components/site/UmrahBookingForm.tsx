...
const UmrahBookingForm: React.FC = () => {
  ...
  return (
    <>
      <div className="booking-form-container rounded-2xl bg-card/20 backdrop-blur border shadow-soft p-2 md:p-6 w-full max-w-[96vw] md:w-auto max-h-[80vh] overflow-y-auto mx-auto">
        ...
        {/* Desktop Layout */}
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-12 md:gap-3 lg:gap-4 md:space-y-0">
          ...
          <div className="md:col-span-2 lg:col-span-12 flex justify-center md:justify-end mt-2">
